...
export const SeasonStatsSummary: React.FC<SeasonStatsSummaryProps> = ({ matches }) => {
  ...
  return (
    <div className="p-4 my-6 bg-white rounded-lg shadow-lg border border-gray-200">
      <h3 className="text-xl font-semibold text-gray-800 mb-4 text-center">Résumé de la Saison</h3>
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4 text-center">
        <div className="p-3 bg-gray-50 rounded-md">
          <div className="text-2xl font-bold text-gray-700">{totalMatches}</div>
        ...
        <div className="p-3 bg-blue-50 rounded-md">
          <div className="text-2xl font-bold text-blue-600">{goalsScoredByTeam}</div>
          <div className="text-sm text-gray-600">Buts Marqués</div>
        </div>
        <div className="p-3 bg-pink-50 rounded-md">
          <div className="text-2xl font-bold text-pink-600">{goalsConcededByTeam}</div>
